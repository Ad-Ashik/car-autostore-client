    ...
    return (
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row">
                <img src="https://i.ibb.co/0Z8vbTP/banner30.jpg" className="lg:w-2/4 object-cover rounded-lg " alt='' />
                <div className='relative' style={{ top: "-50px" }}>
                    <h1 className="text-5xl font-bold">Welcome to Autostore</h1>
                    ...
                    <p className="py-6 text-secondary">Since its founding we become an integral part of the city, advancing our mission of the providing access to compassionate care to our communities. today patient find care that combines world-class medincine with compassion.</p>
                    ...
                    <button className="btn btn-success mt-6">Check Products</button>
                </div>
